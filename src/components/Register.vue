    ...
    <div>
      <div class="columns">
        ...
        <b-field for="heroAvatar" label="Avatar">
            <b-input type="text" name="heroAvatar" v-model="Member.heroAvatar"></b-input></b-field>
...
export default
{
  ...
  methods:{
   submit: function() {
        // Add/Update
    this.$bindAsObject('members',MemberDB.child(this.Member.username),null,function(){
